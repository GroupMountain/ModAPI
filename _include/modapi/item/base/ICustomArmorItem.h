...
public:
    MODAPI_NDAPI ICustomArmorItem(std::string const& identifier, HumanoidArmorItem::Tier armorTier);
    ...
    MOD_API virtual int getModelIndex() const;
    ...
    MOD_API bool isTrimAllowed() const override;
