...
public:
    ...
    MOD_API void         setBlock(const BlockPos& pos, const Block& block, uchar layer = 0, int updateFlags = 0);
    MOD_API const Block& getBlock(const BlockPos& pos, uchar layer = 0) const;
